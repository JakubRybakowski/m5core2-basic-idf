...
void ui_Htop_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_Htop, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_width(ui_labelCharge, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_labelCharge, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_width(ui_labelDischarge, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_labelDischarge, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_width(ui_labelVbus, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_labelVbus, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_width(ui_labelIbus, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_labelIbus, LV_SIZE_CONTENT);    /// 1
